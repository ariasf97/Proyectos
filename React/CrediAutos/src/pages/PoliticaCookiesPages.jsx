import { PolCookiesHero } from '../components/Heros/PolCookiesHero';
...
export const PoliticaCookiesPages = () => {
    return (<Plantilla>
        <>
            <PolCookiesHero />
            <section className="ca-pol-cookies-content">
                <h2 className='ca-pol-cookies-subtitle'>¿QUÉ SON LAS COOKIES?</h2>
